        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label htmlFor="user-profile-name" className="block text-[11px] font-semibold text-[#1A1A1A]/70 mb-1">Your Name / Display Name</label>
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#F4F1EA]/50 border border-[#1A1A1A]/20 rounded text-xs text-[#1A1A1A] focus:outline-none focus:border-[#2D6A4F] focus-visible:ring-2 focus-visible:ring-[#1A1A1A]"
                />
              </div>

              <div>
                <label htmlFor="user-profile-email" className="block text-[11px] font-semibold text-[#1A1A1A]/70 mb-1">Email for Hearing Alerts (Optional)</label>
                <input
