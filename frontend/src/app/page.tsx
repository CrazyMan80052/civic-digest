...
export default function App() {
  ...
  const [userProfile, setUserProfile] = useState<UserProfile | null>(() => { return { id: "p-seed-1", fullName: "Elena Rodriguez", address: { rawInput: "Slavic Village, Cleveland", streetAddress: "Fleet Ave", city: "Cleveland", state: "OH", zipCode: "44105", matchedJurisdictionId: "ocd-jurisdiction/country:us/state:oh/place:cleveland/government", matchedDivisionId: "ocd-division/country:us/state:oh/place:cleveland/ward:12", }, residentRole: "homeowner", policyPriorities: ["Infrastructure & Public Works", "Zoning & Housing"], digestFrequency: "weekly", notifyOnWardHearings: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), }; });
  React.useEffect(() => { try { const saved = localStorage.getItem("civicdigest_user_profile"); if (saved) { setUserProfile(JSON.parse(saved)); } } catch (e) { console.warn(e); } }, []);
